...
<body>
	...
	<div class="container mt-5">
		...
		<div class="card mb-4 shadow-sm">
			<div class="card-header bg-success text-white fw-bold">Thống kê
				số người yêu thích từng video</div>
				...
				<div class="table-responsive">
					<table class="table table-hover mb-0 align-middle table-bordered">
						<thead class="table-dark">
							<tr>
								<th>Video Title</th>
								<th>Số người thích</th>
								<th>Gần nhất</th>
								<th>Lâu nhất</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="r" items="${reportFavorites}">
								<tr>
									<td>${r[0]}</td>
									<td>${r[1]}</td>
		...
		<div class="card mb-4 shadow-sm">
			<div class="card-header bg-info text-white fw-bold">Lọc người
				yêu thích theo video</div>
			<div class="card-body">
				<form action="Reports" method="get" class="d-flex mb-3">
					<input type="hidden" name="action" value="favoriteUsers"> <input
						type="text" name="title" class="form-control me-2"
